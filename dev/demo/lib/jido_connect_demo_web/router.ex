defmodule Jido.Connect.DemoWeb.Router do
  ...
  scope "/", Jido.Connect.DemoWeb do
    ...
    post(
      "/integrations/google/actions/gmail_list_messages",
      IntegrationController,
      :google_gmail_list_messages
    )

    post(
      "/integrations/google/actions/gmail_get_profile",
      IntegrationController,
      :google_gmail_get_profile
    )

    post(
      "/integrations/google/actions/drive_list_files",
      IntegrationController,
      :google_drive_list_files
    )

    post(
      "/integrations/google/actions/drive_get_about",
      IntegrationController,
      :google_drive_get_about
    )

    post(
      "/integrations/google/actions/calendar_list_events",
      IntegrationController,
      :google_calendar_list_events
    )

    post(
      "/integrations/google/actions/calendar_list_calendars",
      IntegrationController,
