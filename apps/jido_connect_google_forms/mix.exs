defmodule JidoConnectGoogleForms.MixProject do
  use Mix.Project

  def project do
    [
      app: :jido_connect_google_forms,
      version: "0.8.0",
      build_path: "../../_build",
  ...
  def application do
    [
      ...
      env: [
        jido_connect_providers: [Jido.Connect.Google.Forms]
      ]
    ]
  end
  ...
  defp package do
    [
      ...
      links: %{
        ...
        "Docs" => "https://hexdocs.pm/jido_connect_google_forms"
      },
