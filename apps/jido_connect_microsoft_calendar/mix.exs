defmodule JidoConnectMicrosoftCalendar.MixProject do
  use Mix.Project

  def project do
    [
      app: :jido_connect_microsoft_calendar,
      version: "0.1.0",
      build_path: "../../_build",
  ...
  def application do
    [
      ...
      env: [
        jido_connect_providers: [Jido.Connect.MicrosoftCalendar]
      ]
    ]
  end
  ...
  defp jido_connect_microsoft_dep do
    if hex_package_task?() do
      {:jido_connect_microsoft, "~> 0.1"}
    else
      {:jido_connect_microsoft, in_umbrella: true}
    end
  end
  ...
  defp package do
    [
      ...
      links: %{
        ...
        "Docs" => "https://hexdocs.pm/jido_connect_microsoft_calendar"
      },
