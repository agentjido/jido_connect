defmodule JidoConnectCalendly.MixProject do
  use Mix.Project

  def project do
    [
      app: :jido_connect_calendly,
      version: "0.8.0",
      build_path: "../../_build",
  ...
  def application do
    [
      ...
      env: [
        jido_connect_providers: [Jido.Connect.Calendly]
      ]
    ]
  end
  ...
  defp package do
    [
      ...
      links: %{
        ...
        "Docs" => "https://hexdocs.pm/jido_connect_calendly"
      },
