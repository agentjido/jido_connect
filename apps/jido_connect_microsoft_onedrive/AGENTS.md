# Microsoft OneDrive Connector Guidance
...
- Use `Jido.Connect.Microsoft.Scopes` for Microsoft Graph file scope
  normalization and encode. Use the OneDrive scope resolver for dynamic
...
- Normalize Graph driveItem payloads through dedicated OneDrive structs once
  they are introduced.
