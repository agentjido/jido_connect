defmodule JidoConnectMicrosoftOnedrive.MixProject do
  use Mix.Project

  def project do
    [
      app: :jido_connect_microsoft_onedrive,
      version: "0.1.0",
      build_path: "../../_build",
  ...
  def application do
    [
      ...
      env: [
        jido_connect_providers: [Jido.Connect.MicrosoftOnedrive]
      ]
    ]
  end
  ...
  defp package do
    [
      ...
      links: %{
        ...
        "Docs" => "https://hexdocs.pm/jido_connect_microsoft_onedrive"
      },
