defmodule Jido.Connect.Google.Docs.Handlers.Actions.BatchUpdateDocument do
  @moduledoc false

  alias Jido.Connect.{Error, Google.Docs.BatchUpdateRequest, Google.Docs.Client}
  ...
  defp normalize_result(result) do
    ...
    output = if document, do: Map.put(output, :document, document), else: output
    output
  end
end
