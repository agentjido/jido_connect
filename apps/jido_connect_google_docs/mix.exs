defmodule JidoConnectGoogleDocs.MixProject do
  use Mix.Project

  def project do
    [
      app: :jido_connect_google_docs,
      version: "0.1.0",
      build_path: "../../_build",
  ...
  def application do
    [
      ...
      env: [
        jido_connect_providers: [Jido.Connect.Google.Docs]
      ]
    ]
  end
  ...
  defp package do
    [
      ...
      links: %{
        ...
        "Docs" => "https://hexdocs.pm/jido_connect_google_docs"
      },
