defmodule JidoConnectX.MixProject do
  use Mix.Project
  ...
  def application do
    [
      ...
      env: [jido_connect_providers: [Jido.Connect.X]]
    ]
  end
  ...
  defp description do
    "Reviewed read-only X actions over the official local XMCP endpoint."
  end
  ...
  defp package do
    [
      ...
      links: %{
        ...
        "Docs" => "https://hexdocs.pm/jido_connect_x"
      },
