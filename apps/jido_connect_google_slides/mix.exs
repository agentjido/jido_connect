defmodule JidoConnectGoogleSlides.MixProject do
  use Mix.Project

  def project do
    [
      app: :jido_connect_google_slides,
      version: "0.1.0",
      build_path: "../../_build",
  ...
  def application do
    [
      ...
      env: [
        jido_connect_providers: [Jido.Connect.Google.Slides]
      ]
    ]
  end
  ...
  defp package do
    [
      ...
      links: %{
        ...
        "Docs" => "https://hexdocs.pm/jido_connect_google_slides"
      },
