defmodule JidoConnectMicrosoftOutlook.MixProject do
  use Mix.Project

  def project do
    [
      app: :jido_connect_microsoft_outlook,
      version: "0.1.0",
      build_path: "../../_build",
  ...
  def application do
    [
      ...
      env: [
        jido_connect_providers: [Jido.Connect.MicrosoftOutlook]
      ]
    ]
  end
  ...
  defp package do
    [
      ...
      links: %{
        ...
        "Docs" => "https://hexdocs.pm/jido_connect_microsoft_outlook"
      },
