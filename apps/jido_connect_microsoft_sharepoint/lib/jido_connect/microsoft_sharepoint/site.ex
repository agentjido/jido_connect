defmodule Jido.Connect.MicrosoftSharepoint.Site do
  @moduledoc "Normalized Microsoft Graph SharePoint `site` resource."
  ...
  @schema Zoi.struct(
            ...
            %{
              ...
              is_personal_site: Zoi.boolean() |> Zoi.nullish() |> Zoi.optional(),
              site_collection: Zoi.map() |> Zoi.nullish() |> Zoi.optional(),
